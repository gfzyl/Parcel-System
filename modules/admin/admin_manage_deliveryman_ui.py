...
"            ")
    ...
    def retranslateUi(self, admin_manage_deliveryman):
        ...
        ___qtablewidgetitem4.setText(QCoreApplication.translate("admin_manage_deliveryman", u"\u5de5\u4f5c\u70b91", None));
        ___qtablewidgetitem5 = self.tableWidget.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("admin_manage_deliveryman", u"\u5de5\u4f5c\u70b92", None));
        ...
        self.searchBtn.setText(QCoreApplication.translate("admin_manage_deliveryman", u"\u67e5\u8be2", None))
